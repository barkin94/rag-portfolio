...
export default () => {
  return (
    <section className="relative bg-linear-to-br from-white via-indigo-50/30 to-purple-50/30 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800 rounded-3xl p-4 lg:p-8 shadow-xl border border-slate-200 dark:border-slate-800 h-fit overflow-hidden">
