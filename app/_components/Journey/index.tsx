      ...
      <div className="relative border-l-2 border-stone-200 dark:border-stone-700">
        {timelineItems.map((item, index) => (
          <div key={index} className="mb-8 flex items-start w-full">
            <div className="relative z-1 shrink-0 w-5 h-5 bg-white dark:bg-black border-stone-500 border-3 border-solid rounded-full mt-1.5 -ml-2.5">
              <div className="absolute right-1 top-1 z-2 shrink-0 w-1.75 h-1.75 bg-black dark:bg-white rounded-full"></div>
            </div>
            ...
            <div className="grow pl-8">
              <Card>
                <div className='flex justify-between mb-4'>
                  ...
                  <div className="text-md rounded-2xl bg-white/15 px-3 py-1 h-fit">{item.startDate} - {item.endDate}</div>
                </div>
