...
Summary: Backend Engineer with strong full-stack experience, specializing in designing, building and optimizing high-performance systems. Proven track record of enhancing scalability, reducing API latency, minimizing cloud infrastructure costs, and resolving complex, system-level issues across entire stacks. Expertise includes designing distributed systems using Go, Node.js, and AI-driven development practices, among other modern technologies.
...
Details:
• Improved API performance and system scalability by reworking legacy backend services
• Integrated Google's AI-powered search platform to significantly improve product search relevance and accuracy
...
• Built an HTTP mock server letting QA simulate any edge-case response without cross-team coordination

Technologies: NestJS, Node.js, Spring Boot, MongoDB, PostgreSQL, Redis, Kafka, Kubernetes, Terraform, AWS, GCP
    `,
    metadata: {
...
Technologies: TypeScript, React, Next.js, Redux, Redux-Saga, Jest, Storybook, styled-components, Node.js`,
    metadata: {
      tags: [Topic.WorkExperience, Topic.Achievements],
      source: "resume work experience section",
    },
...
Technologies: TypeScript, React, Redux, MongoDB, NestJS, Express.js, Node.js, Socket.io, Docker, AWS
  ...
  new Document({
    pageContent: `
Backend: Go, TypeScript, JavaScript, Node.js (Fastify, Express.js, NestJS), Java (Spring Boot)
